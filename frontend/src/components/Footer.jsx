            ...
            <Row className="text-center text-md-start align-items-center">
                ...
                <Col xs={12} md={4} className="mb-4 mb-md-0">
                    <div className="d-flex flex-column align-items-center align-items-md-start">
                        <Nav.Link href="https://maps.app.goo.gl/PHmiMnHmtX8JZMkw6" className="p-1"><small>Unipen HPA Dental and Physiotherapy</small></Nav.Link>
                        <Nav.Link href="https://maps.app.goo.gl/PHmiMnHmtX8JZMkw6" className="p-1"><small>Ground Floor Block B</small></Nav.Link>
                    </div>
                </Col>
                <Col xs={12} md={4}>
                    <div className="d-flex flex-column align-items-center align-items-md-start">
